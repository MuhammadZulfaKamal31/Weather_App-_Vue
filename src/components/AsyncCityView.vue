            ...
            <div class=" mx-8 text-white">
                ...
                <div class="flex gap-10 overflow-x-scroll ">
                    <div v-for="hourData in weatherData.hourly" :key="hourData.dt"
                        ...
                        <p class="whitespace-nowrap text-md">{{ new Date(
...
const getWeatherData = async () => {
    try {
        ...
        return weatherData.data; // Return the weather data
    } catch (err) {
        console.log(err);
        return null; // Handle error and return null or some default value
    }
};
